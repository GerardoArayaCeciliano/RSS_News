...
const rss_feed_emitter_1 = __importDefault(require("rss-feed-emitter"));
const news_handler_1 = require("./handlers/news-handler");
const rssList = __importStar(require("./rss-list.json"));
(function main() {
